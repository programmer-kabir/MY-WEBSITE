                ...
                <div className="px-5 pt-10 space-y-3">
                    {isAdmin && (
                        <>
                            <NavLink
                                to="home"
                                className={({ isActive }) =>
                                    `font-semibold transition-all disabled:opacity-50 hover:bg-gray-700 disabled:shadow-none disabled:pointer-events-none text-base py-3 rounded-lg  text-white active:opacity-[0.85] w-full flex items-center gap-4 px-5 capitalize ${isActive ? activeLinkClass : "text-white"
                                    }`
                                }
                            >
                                s
                    ...
                    {!isAdmin && (
                        <>
                            ...
                            >
                                <span>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="#FFAE00" xmlns="http://www.w3.org/2000/svg">
