        ...
        <div className=''>
            ...
            <div>
                <form className='space-y-6 w-[800px] mx-auto border-2 p-10 my-10 bg-[#39e692] formShadow' >
                    {/* title  */}
                    <div>
                        <label htmlFor="" className='text-ms text-gray-600'>Components Title</label> <br />
                        <input className='border-2 w-full rounded-full p-2 bg-[#EDF2F7]' type="text" name='title' />
                    </div>
                    {/* components category  */}
                    <div>
                        <label htmlFor="" className='text-ms text-gray-600'>Components Category</label> <br />
                        <input className='border-2 w-full rounded-full bg-[#EDF2F7] p-2' type="text" name='category' />
                    </div>
                    {/* components image  */}
                    <div>
                        <label htmlFor="" className='text-ms text-gray-600'>Components Image</label> <br />
