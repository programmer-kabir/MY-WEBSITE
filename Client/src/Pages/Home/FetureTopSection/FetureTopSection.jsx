    ...
    return (
        ...
        <section className='w-10/12 mx-auto'>
            ...
            {/* <div className='border relative text-center space-y-3 p-2 shadow-md'>
             ...
             <div className='border xl:h-[300px] relative text-center space-y-3 p-2 shadow-md'>
                <span className='flex justify-center'><FcTemplate className='text-6xl'></FcTemplate></span>
                <h2 className='text-4xl font-semibold font-markazi'>HTML & Tailwind</h2>
                <p className='2xl:px-16 md:px-5'> 100+ Ready for html Tailwind Components.</p>
                <button className='btn absolute bottom-2 mx-16 right-0  left-0 bg-[#0070ff] text-xl hover:bg-[#004acf] px-6 py-2 text-white font-markazi rounded-md'>Get More</button>
            </div>
            <div className='border relative text-center space-y-2 p-2 shadow-md'>
